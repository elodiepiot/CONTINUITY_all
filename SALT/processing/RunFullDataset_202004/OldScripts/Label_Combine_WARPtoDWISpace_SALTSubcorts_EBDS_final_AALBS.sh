...
subcorticals=(AmyL AmyR CaudL CaudR GPL GPR HippoL HippoR PutL PutR ThalL ThalR Brainstem)
...
outputSurfaceFullMerge="${outDirForCivility}/Input_Civility_DWISpace/stx_${ID}_T1_CombinedSurface_white_${parc}_WithSubcorticals_Brainstem.vtk"
...
if [ -f $inputMerge ]; then
	...
	copyMerge="/work/maria5/EBDS_CIVILITY/LongitudinalConnectome_PostRegError/SubCortical_Processing/Collected_FinalSurfaces/stx_${ID}_T1_CombinedSurface_white_${parc}_WithSubcorticals_Brainstem.vtk"
