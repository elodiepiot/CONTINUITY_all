...
#ID=$subject
	...
	ID=$idx
echo $ID
	# some of the brain stem will not have spherical topology - establish a counter. 
...
cmd="SegPostProcessCLP $BrainStemPostProcess1 $BrainStemPostProcessFinal --space 0.75,0.75,0.75 --rescale --Gauss  "  
eval $cmd
 
# Surface Generation using SPHARM
# Parameterization
cmd="GenParaMeshCLP $BrainStemPostProcessFinal $BrainStemPara $BrainStemInitialSurf "
eval $cmd
