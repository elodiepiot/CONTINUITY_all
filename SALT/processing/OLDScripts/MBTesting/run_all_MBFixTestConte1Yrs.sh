...
bash ./run_MBFix_Conte1Yrs.sh  /NIRAL/work/maria5/EBDS_CIVILITY/LongitudinalConnectome_PostRegError/SubCortical_Processing/SALT/processing/Healthy_SubjectsWith_1Yr_2Yr_4Yr_WMData/Final/Conte1Yrs_Final.txt 0 
